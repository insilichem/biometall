...
BioMetAll is an open-source software licensed under the LGPL-3. Check the details in the `LICENSE <https://github.com/insilichem/biometall/blob/master/LICENSE>`_ file.
